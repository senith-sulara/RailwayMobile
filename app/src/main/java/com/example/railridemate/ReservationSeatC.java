...
public class ReservationSeatC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seatsRef = database.getReference("seatsC");
        // Initialize handler
        handler = new Handler();
        ...
        seatC = findViewById(R.id.buttonB);
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ReservationSeatC.this, Passenger.class);
        ...
        seatA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the payment activity
                Intent intent = new Intent(ReservationSeatC.this, Reservationseat.class);
                startActivity(intent);
            }
        });
        seatC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the payment activity
                Intent intent = new Intent(ReservationSeatC.this, ReservationSeatB.class);
                startActivity(intent);
            }
        });
        seatD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the payment activity
               Intent intent = new Intent(ReservationSeatC.this, ReservationSeatD.class);
                startActivity(intent);
            }
        });
    }
        ...
        seatsRef.child(seatId).child("bookingTime").setValue(bookingTime)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(ReservationSeatC.this, "Seat status updated successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(ReservationSeatC.this, "Failed to update seat status", Toast.LENGTH_SHORT).show();
                    }
                });
    }
