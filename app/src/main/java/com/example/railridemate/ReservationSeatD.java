...
public class ReservationSeatD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reservation_seat_d);
        // Initialize Firebase
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        seatsRef = database.getReference("seatsD");
        // Initialize handler
        handler = new Handler();
        ...
        seatD = findViewById(R.id.buttonB);
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ReservationSeatD.this, Passenger.class);
        ...
        seatA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the payment activity
                Intent intent = new Intent(ReservationSeatD.this, Reservationseat.class);
                startActivity(intent);
            }
        });
        seatC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the payment activity
                Intent intent = new Intent(ReservationSeatD.this, ReservationSeatC.class);
                startActivity(intent);
            }
        });
        seatD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the payment activity
               Intent intent = new Intent(ReservationSeatD.this, ReservationSeatB.class);
                startActivity(intent);
            }
        });
    }
        ...
        seatsRef.child(seatId).child("bookingTime").setValue(bookingTime)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(ReservationSeatD.this, "Seat status updated successfully", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(ReservationSeatD.this, "Failed to update seat status", Toast.LENGTH_SHORT).show();
                    }
                });
    }
